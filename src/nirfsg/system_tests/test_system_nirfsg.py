...
# Utility method tests
    ...
    @pytest.mark.skipif(use_simulated_session == False, reason="Takes long time in real device")
    def test_self_cal(self, test_rfsg_device_session):
        test_rfsg_device_session.self_cal()

    @pytest.mark.skipif(use_simulated_session == True, reason="Bad date returned by driver for simulated device")
...
# Configuration methods related tests
    ...
    @pytest.mark.skipif(use_simulated_session == True, reason="Scripts not compiled on simulated device")
    ...
    @pytest.mark.skipif(use_simulated_session == True, reason="RoCo is not invoked for simulated device")
...
# Basic tests for generation
    @pytest.mark.skipif(use_simulated_session == False, reason="Test executed with status check in real hw")
    ...
    @pytest.mark.skipif(use_simulated_session == True, reason="IsDone is always True on simulated device")
