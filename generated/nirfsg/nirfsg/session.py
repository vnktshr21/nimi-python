...
class Session(_SessionBase):
    ...
    def write_arb_waveform(self, waveform_name, waveform_data_array, more_data_pending):
        ...
        Args:
            ...
            waveform_data_array (list of NIComplexNumber): Specifies the array of data to load into the waveform. The array must have at least as many elements as the value in the **size_in_samples** parameter in the allocate_arb_waveform method.
